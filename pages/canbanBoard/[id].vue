      ...
      <div class="flex justify-center">
        <div class="grid grid-cols-1 gap-5 w-full">
          ...
          <div class="bg-white dark:bg-[#121212] p-5 shadow-md rounded-lg flex-grow border-2 border-solid border-slate-200">
            <h1 class="dark:text-white text-lg font-bold w-full text-center mb-3 mt-3">Create a new column</h1>
          ...
          <div class="bg-white dark:bg-[#121212] p-5 shadow-md rounded-lg flex-grow border-2 border-solid border-slate-200">
            <h1 class="dark:text-white text-lg font-bold w-full text-center mb-3 mt-3">Add task to an existing column</h1>
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-5 w-full">
              ...
              <input v-model="newTaskName" type="text" class="py-2 px-3 rounded border border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter task name">
              <div></div>
              <button @click="createTask" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700">Add Task</button>
            </div>
          </div>

          <!-- Canban board -->
          <div class="bg-white dark:bg-[#121212] p-5 shadow-md rounded-lg flex-grow border-2 border-solid border-slate-200">
            <h1 class="dark:text-white text-lg font-bold w-full text-center mb-3 mt-3">Canban board</h1>
